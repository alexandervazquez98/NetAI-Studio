    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-bold bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded flex-shrink-0">
            ACCESS
          </span>
        </div>
        ...
        {/* Port count */}
        {data.port_count !== undefined && (
          <div className="text-xs text-gray-600 mt-1">
            Puertos: <span className="font-semibold text-gray-700">{data.port_count}</span>
          </div>
        )}
