  ...
  return (
    <>
      ...
      <div
        ...
        className={`bg-white rounded-lg border-2 shadow-md px-4 py-3 min-w-[160px] max-w-[220px] transition-all duration-150 ${selected ? 'border-blue-500 ring-2 ring-blue-200' : 'border-gray-200'}`}
      >
