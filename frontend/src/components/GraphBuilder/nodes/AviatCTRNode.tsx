...
export const AviatCTRNode: React.FC<NodeProps<NodeData>> = ({ data, selected }) => (
  <>
    <NodeHandles color="!bg-purple-500" />
    <div className={`bg-white rounded-lg border-2 shadow-md px-4 py-3 min-w-[160px] max-w-[220px] transition-all duration-150 ${selected ? 'border-purple-500 ring-2 ring-purple-200' : 'border-gray-200'}`}>
