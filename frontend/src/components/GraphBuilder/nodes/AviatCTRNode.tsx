    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-bold bg-purple-100 text-purple-700 px-1.5 py-0.5 rounded flex-shrink-0">
            CTR
          </span>
        </div>
        ...
        {/* WAN links count */}
        {data.wan_links !== undefined && (
          <div className="text-xs text-gray-600 mt-1">
            WAN links: <span className="font-semibold text-purple-700">{data.wan_links.length}</span>
          </div>
        )}
