...
export const SdwanCPENode: React.FC<NodeProps<NodeData>> = ({ data, selected }) => {
  return (
    <>
      ...
      <div
        className={`
          bg-white rounded-lg border-2 border-dashed shadow-md px-4 py-3 min-w-[170px] max-w-[230px]
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-bold bg-amber-100 text-amber-700 px-1.5 py-0.5 rounded flex-shrink-0">
            SD-WAN
          </span>
        </div>

        {/* Black box badge */}
        <div className="bg-amber-500 text-white text-xs font-bold rounded px-2 py-1 text-center mb-2">
          ⚠ Caja Negra
        </div>
        ...
        {/* Tooltip hint */}
        <div className="text-xs text-amber-600 mt-1 italic leading-tight">
          Métricas inferidas desde SW-EXT
        </div>
      </div>
